    ...
    def get_index(self):
        try:
            ...
            if response.status_code != 200:
                raise RepoManagerError("Get helm repo index failed. Helm repo return status code: "+ str(response.status_code)  +" "+ response.content.decode("utf-8"), response.status_code)
